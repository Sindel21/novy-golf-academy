    ...
    <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          srcSet="https://images.unsplash.com/photo-1587174486073-ae5e5cff23aa?auto=format&fit=crop&q=80&w=800 800w, https://images.unsplash.com/photo-1587174486073-ae5e5cff23aa?auto=format&fit=crop&q=80&w=1200 1200w"
          sizes="100vw"
          alt="Golf background"
