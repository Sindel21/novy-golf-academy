...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center pt-24 pb-32 md:pt-20 md:pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 pb-12 md:pb-0">
